...
var YJSay = (function ($) {
    ...
    var weixin = {appId:"wx93ccd8dccdd06205",nonceStr:"abmCjtoylKuhT67y",timestamp:1466063635};
	return {
        ...
        getToken: function () {
            if(is_PC()){
                token = "69BD04E02C264E4AB63D835504A2FE6B";
                return token;
            }else{
                if(!token){
                    if(window.bridge){
		...
		initWXSDK:function(){
			...
			wx.config({
			  ...
			  signature: '746c3c8be1f0b117836a1e17a8ec841854b477b8',
			  jsApiList: [
				'checkJsApi',
				'onMenuShareTimeline',
