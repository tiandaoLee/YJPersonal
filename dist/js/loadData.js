        ...
        YJSay.getData({
            ...
            success: function (data) {
                ...
                if(_userInfo&&!YJSay.isEmptyObject(_userInfo)){
                    $("#YJ_HOME_USERNAME").text(YJSay.is_weiXin()?_userInfo.name.substr(1,5)+"...":_userInfo.name);//用户名
        ...
        YJSay.getData({
            ...
            success: function (data) {
                ...
                $.each(data.list, function () {
                    _html+="<tr><td>"+this.index+"</td><td>"+(YJSay.is_weiXin()?this.name.substr(1,5)+"...":this.name)+"</td><td>"+this.accountId+"</td><td>"+this.socre+"</td></tr>";
                });
